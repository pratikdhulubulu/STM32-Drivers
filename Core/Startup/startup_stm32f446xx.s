 ...
 * @brief Startup code for STM32F446RE Cortex-M4 MCU.
 *
 * @details
 * Contains:
 * - Vector table
 * - Reset handler
 * - Memory initialization (.data copy, .bss zero)
 * - Weak default interrupt handlers
 *
 * This file is executed immediately after reset before entering main().
 */
 ...
 *--------------------------------------------------------------------------*/
/**
 * @section VectorTable Interrupt Vector Table
 * @brief Maps all core exceptions and peripheral interrupts to handlers.
 *
 * - The first entry is the initial stack pointer.
 * - The second entry is Reset_Handler.
 * - All other entries are interrupt handlers.
 *
 * Weak handlers redirect to Default_Handler unless overridden in C code.
 */
 ...
 *--------------------------------------------------------------------------*/
/**
 * @brief Symbols generated by linker script.
 *
 * - _sidata : Start of init values for .data in Flash
 ...
 *--------------------------------------------------------------------------*/
/**
 * @brief Performs system initialization after reset.
 *
 * @details
 * Steps:
 * 1. Copy initialized data from Flash → RAM (.data)
 * 2. Zero initialize the .bss section
 * 3. Call SystemInit() for clock and system configuration
 * 4. Jump to main()
 */
 ...
 *--------------------------------------------------------------------------*/
/**
 * @brief Default infinite-loop handler for unimplemented interrupts.
 *
 * @details
 * All IRQ handlers are weakly aliased to this.
 * User can override by defining their own handler in C.
 */
...
/* Core Handlers (weak) */
/**
 * @name Core Exception Handlers (Weak)
 * @brief All weak unless user overrides in C.
 * @{
 */
.weak NMI_Handler
 ...
 *---------------------------------------------------------------------------*/
/**
 * @section PeripheralHandlers Peripheral Interrupt Handlers (Weak)
 * @brief 
 * All IRQ handlers are declared weak and redirect to Default_Handler
 * unless overridden by user in application code.
 */
