/**
 * @file    timer_driver.h
 * @brief   Timer Driver Interface for STM32F446xx.
 * @details This module provides APIs for configuring and controlling
 *          general-purpose timers in various modes such as timer basic,
 *          PWM, input capture, output compare, and encoder.
 */
